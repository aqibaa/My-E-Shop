...
import {
  Package, User, MapPin, Settings, LogOut, Eye, Loader2
} from "lucide-react"
            ...
            {orders.length > 0 ? (
                ...
                {orders.map((order) => (
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <Badge variant={getStatusVariant(order.isDelivered)} className="rounded-lg text-[10px]">
                            {order.isDelivered}
                        </Badge>
                        </div>
                ...
                <UserProfile 
                    appearance={{
                        elements: {
                            ...
                            navbar: "hidden", // Humne apna navbar banaya hai isliye isko hide kar diya
                            pageScrollBox: "p-6",
                        }
                    }}
                />
